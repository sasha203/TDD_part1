...
public class WeatherTest {
	...
	public void check_for_valid_apiKey() {
		...
		assertEquals("http://api.openweathermap.org/data/2.5/weather?q=valletta&units=metric&appid=d12e761b653064784c9d028522c92fe9",wt.[());
	}
	...
	public void requesting_all_info_from_api_method() {
		...
		configList.add("Valletta");
		wt.configure(configList);
		assertEquals(12,  wt.getAllApiValues().size());
	}
	...
	public void Weather_Driver() {
		...
		if(wt.configure(configList)) {
			wt.run();
			assertEquals(17.60,  wt.getTemp(),0.50);
		}
	}
